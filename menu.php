...
<head>
    ...
    body {
        height: 100vh;
        background-image: url("./assets/imgs/pexels-goumbik-616401.jpg");
...
<body>
    ...
    <div class="content">
        <section id="fetch_product" class="p-5">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-4">
                            <div class="card bg rounded-4" style="box-shadow: 5px 5px 10px rgba(29, 29, 29, 1);">
                                <div class="card-body">
                                    <div class="ratio ratio-16x9" style="max-width: 370px;">
                                        <a href="./assets/imgs/<?= htmlspecialchars($row['product_image']); ?>"
                                            target="_blank">
                                            <img src="./assets/imgs/<?= htmlspecialchars($row['product_image']); ?>"
                                                alt="" class="hov rounded w-100 h-100">
                                        </a>
                                    </div>
                                    ...
                                    <div class="d-flex justify-content-between gap-3">
                                        <a href="editfood.php?id=<?= $row['id'] ?>"
                                            class="btn btn-outline-warning border-2 mb-3 w-50 p-2">
                                            <i class="bi bi-pencil-square"></i>
                                        </a>
                                        <button class="btn btn-outline-danger border-2 mb-3 w-50"
